...
private:
    DoublyLinkedList<DoublyLinkedList<Ficha*>> matriz_fichas;  /** matriz de fichas */
    ListaFichas* saco_fichas;  /** Saco de fichas totales */
    TXT_Manager* buscador = new TXT_Manager();  /** Buscador de palabras */
    list<Player> *jugadores = jugadores;  /** Lista de jugadores */
};
